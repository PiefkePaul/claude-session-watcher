...
def test_insights_calculate_burn_rate_when_reset_timestamp_changes():
    ...
    samples = [
        ...
        UsageSample(
            ...
            account_watcher_id=1,
            source="test",
            five_hour_utilization=16.0,
            five_hour_resets_at="2026-05-26T15:10:00+00:00",
            created_at="2026-05-26T11:00:00+00:00",
        ),
    ]
    ...
    assert insights.five_hour_burn_per_hour == 6.0
    assert insights.five_hour_pause_at == "2026-05-27T00:10:00+00:00"
